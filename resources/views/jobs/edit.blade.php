    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/jobs/{{$job->id}}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="title" placeholder="Example: Senior React.js Developer" value="{{$job->title}}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="tags" placeholder="Example: react, frontend, next, etc" value="{{$job->tags}}" />
            ...
            <div class="mb-6">
                <button class="bg-react hover:bg-blue-400 text-white rounded py-2 px-4">
                    Update Job
                </button>
